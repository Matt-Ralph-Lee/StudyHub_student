...
class NotificationCardSkeletonWidget extends StatelessWidget {
  const NotificationCardSkeletonWidget({super.key});
  ...
  Widget build(BuildContext context) {
    ...
    return Container(
      ...
      child: Padding(
        padding: EdgeInsets.all(PaddingSet.getPaddingSize(context, 20)),
