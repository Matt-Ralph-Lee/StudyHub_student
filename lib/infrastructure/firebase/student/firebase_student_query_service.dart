...
import 'firebase_student_repository.dart';

class FirebaseStudentQueryService implements IGetMyProfileQueryService {
  final FirebaseStudentRepository _repository;

  FirebaseStudentQueryService(this._repository);
