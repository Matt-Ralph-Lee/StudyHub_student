...
import 'package:studyhub/application/question/application_service/search_for_question_use_case.dart';
...
void main() {
  ...
  setUp(() {
    ...
    final questionMadeByStudent2 = Question(
        ...
        questionSubject: Subject.highMath,
        questionTitle: QuestionTitle('部分積分について'),
        questionText: QuestionText('部分積分の使い所がわかりません'),
        questionPhotoPathList: QuestionPhotoPathList([]),
        studentId: studentId2,
        answerList: AnswerList([]),
        seenCount: SeenCount(1),
