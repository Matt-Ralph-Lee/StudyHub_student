...
import 'package:studyhub/application/question/application_service/get_recommended_questions_use_case.dart';
...
import 'package:studyhub/infrastructure/in_memory/question/in_memory_get_recommended_questions_query_service.dart';
...
void printQuestionCardList(final List<QuestionCardDto> questionCardList) {
  for (final dto in questionCardList) {
    debugPrint('title : ${dto.questionTitle}');
  }
}
